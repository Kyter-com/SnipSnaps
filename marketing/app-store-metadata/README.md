...
• Improved video playback behavior and similar-photo scan responsiveness.
• Added muted autoplay for video review cards and a location map in details when location data is available.
